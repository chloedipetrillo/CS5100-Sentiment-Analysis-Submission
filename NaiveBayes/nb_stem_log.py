...
def train(train_data, train_labels):
    ...
    return (prob_pos, prob_neu, prob_neg, prob_word_given_positive, prob_word_given_negative, prob_word_given_neutral, 
            positive_word_count, total_vocabulary_size, word_count_negative, word_count_neutral)
...
def test(test_data, test_labels, prob_pos, prob_neu, prob_neg, prob_word_given_positive, prob_word_given_negative, 
    ...
    for review, sentiment in zip(test_data.values, test_labels):
        ...
        # using log probabilities (so addint probabilities) determine probability of a class given a document
        for  word in review.split():
